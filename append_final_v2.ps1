...
$target = 'interface LanguageContextType'
$injection = @"
  ...
  'Material Database':              { English: 'Material Database',              Hindi: 'सामग्री डेटाबेस',               Marathi: 'साहित्य डेटाबेस',              Urdu: 'مواد डाटा बेस' },
  ...
  'Input required for logic continuity': { English: 'Input required for logic continuity', Hindi: 'तार्किक निरंतरता के लिए इनपुट आवश्यक', Marathi: 'तार्किक सातत्य राखण्यासाठी माहिती आवश्यक', Urdu: 'منطق کے تسلسل کے لیے ان پट درکار ہے' },
  ...
  'Back to Hub':                     { English: 'Back to Hub',                    Hindi: 'हब पर वापस',                  Marathi: 'हबवर परत',                    Urdu: 'हब पर वापस' },
...
if ($content.Contains($target)) {
    $newContent = $content.Replace($target, ($injection + "`n" + $target))
